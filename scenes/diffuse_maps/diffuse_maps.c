...
#define SCENE_PATH "scenes/diffuse_maps/"

#include "diffuse_maps.h"
...
int diffuse_maps_scene(void)
{
	...
	while(!glfwWindowShouldClose(window))
	{
		...
		ShaderSetInt(&lightingShader ,"material.diffuse", 0);
		...
		*/
		ShaderSetVec3(&lightingShader, "light.position", lightPos);
